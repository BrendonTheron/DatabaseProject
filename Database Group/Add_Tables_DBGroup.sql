...
CREATE TABLE STAFF_HISTORY (
    ...
    DEPT_ID VARCHAR2(50),  -- FK REFERECE DEGREE
...
CREATE TABLE UNIT (
    ...
    UNIT_FURNISH CHAR(1) CHECK (UNIT_ISFURNISHED IN ('T', 'F')) NOT NULL,  -- BOOLEAN TRUE/FALSE
    UNIT_RENT NUMBER(10, 2) NOT NULL,  -- MONTHLY RENT 2DP
